        ...
        <div class="text-entry">
            ...
            @if (Request::has('edit_mode'))
                <a href="{{ route('recipes.edit_general_data', $recipe->recipe_id) }}">
                    <i class="fas fa-pencil-alt">Загальна інформація</i>
                </a>
            @endif
            ...
            <tbody>
                @foreach ($recipe->recipe_ingredients as $recipe_ingredient)
                    <tr>
                        ...
                        @if (Request::has('edit_mode'))
                            <td><button data-bs-toggle="modal" data-bs-target="#deleteIngredientModal-{{ $recipe_ingredient->recipe_ingredient_id }}"><i class="fas fa-trash-alt"></i></button></td>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="ModalLabel">Видалення Інгрідієнту</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            Видалити цей Інгрідієнт?
                                        </div>
                        ...
                        @if (Auth::user()->user_id == $recipe_comment->user_id)
                            <div>
                                <li class="navitem dropdown user-menu-block">
                                    ...
                                    <li><button data-bs-toggle="modal" data-bs-target="#deleteCommentModal-{{ $recipe_comment->recipe_comment_id }}">Видалити</button></li>
                                    </ul>
                                </li>
                            </div>
